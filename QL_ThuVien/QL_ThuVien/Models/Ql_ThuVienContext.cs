...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-2022OMW\\SQLEXPRESS;Database=Ql_ThuVien;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblDonMuonSach>(entity =>
            {
                ...
                entity.Property(e => e.StMaSinhVien).HasColumnName("St_MaSinhVien");
            ...
            modelBuilder.Entity<TblSinhVien>(entity =>
            {
                ...
                entity.Property(e => e.InSoDienThoai).HasColumnName("In_SoDienThoai");
                ...
                entity.HasOne(d => d.StMaSinhVienNavigation)
                    .WithOne(p => p.TblSinhVien)
                    .HasForeignKey<TblSinhVien>(d => d.StMaSinhVien)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Tbl_SinhVien_Tbl_TaiKhoan");
            });
            ...
            modelBuilder.Entity<TblTaiKhoan>(entity =>
            {
                ...
                entity.Property(e => e.StQuyenHan)
                    .IsRequired()
                    .HasColumnName("St_QuyenHan")
                    .HasMaxLength(10)
                    .IsFixedLength();
            });
